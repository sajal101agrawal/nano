...
export async function GET(
  ...
  try {
    ...
    const profile = await queryOne<
      Pick<CandidateProfile, "raw_cv_url" | "raw_cv_filename">
    >(
    ...
    // Try to get actual content type from S3 object metadata
    try {
      ...
      // Fall through with extension-based type
    }
    ...
    return new NextResponse(buffer, {
      ...
      headers: {
        ...
        // inline for PDF preview; attachment for Word triggers download
